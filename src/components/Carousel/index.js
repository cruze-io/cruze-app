...
var carousel = React.createClass({
  ...
  componentWillMount: function() {
    ...
    springConfig.tension = this.props.tension || 150;
    springConfig.friction = this.props.friction || 10;
    springConfig.duration = this.props.duration || 200;
    var that = this;
  ...
  movePage(currentPage){
    ...
    if (this.props.slideHasChanged) {
      const self = this;
      self.props.slideHasChanged(this.state.currentPage);
    }
  },
  ...
  getPager() {
    ...
    var left = ((width - (this.props.children.length * (this.props.pagerSize+this.props.pagerMargin)))/2) - 10;
    return (
